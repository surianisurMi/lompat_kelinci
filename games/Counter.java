...
public class Counter extends Actor
{
    ...
    {
         setImage(new GreenfootImage("0", 30, Color.WHITE, Color.RED)); //membuat tampilan counter dengan ukuran awal 30, tulisan warna putih, backgroun merah
    }
    public void Counting (int hitung) // method Counting
    {
         totalCount += hitung;
         setImage(new GreenfootImage("" + totalCount, 30, Color.WHITE, Color.RED)); //membuat tampilan perubahan counter dengan ukuran awal 30, tulisan warna putih, backgroun merah
    }
